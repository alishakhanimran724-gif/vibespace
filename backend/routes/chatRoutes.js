...
router.post  ("/message/:chatId/image",   isAuthenticated, upload.single("image"), sendImageMessage);
router.post  ("/message/:chatId/audio",   isAuthenticated, upload.single("audio"), sendAudioMessage);
